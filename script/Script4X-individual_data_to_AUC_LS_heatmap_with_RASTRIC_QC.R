### VERSION CONTROL
# version 7.1 (19-06-2024):
# deze heb ik per ongeluk gewijzigd, adhv versie 6 heb ik de wijzigingen terug-
# gezet, en na controle werkt hij zoals hiervoor, maar dat kan erachter zitten
# als iets onverhoopt toch anders werkt dan verwacht. 

# Versie 7.2 (17-07-2024):
# Heatmap plot werkte niet direct, maar wel na veranderen van toewijzing van 
# "Chemo naive" naar chemo_naive ipv andersom. 

# Version X (current):
# Reverted to original selection method (Passed_QC only) but using new VRASTRIC overview file
# Output folder changed to 250714_STRATEGIC_AND_RASTRIC_QC
...
metrics_normalized_dir <- file.path(metrics_dir, "250714_STRATEGIC_AND_RASTRIC_QC")

# Load the new VRASTRIC overview file
overview <- read_excel(file.path(resource_dir, "Screening_overview(VRASTRIC).xlsx"))
...
# Run the analysis with the new VRASTRIC overview file
df <- save_metrics("250714_STRATEGIC_AND_RASTRIC_QC")
make_boxplots("250714_STRATEGIC_AND_RASTRIC_QC", df)

# Load the normalized data for heatmap creation
norm_df2 <- read_excel(file.path(metrics_dir, "250714_STRATEGIC_AND_RASTRIC_QC", "250714_STRATEGIC_AND_RASTRIC_QC_metrics_normalized.xlsx"))
...
exp_name_current = "250714_STRATEGIC_AND_RASTRIC_QC"
...
make_heatmap(exp_name_current, norm_df2, selection=scurve, selection_name = "scurveqqq")
make_heatmap(exp_name_current, norm_df2, selection=singles, selection_name = "singlez")
...
# make_heatmap(exp_name_current, norm_df2, selection=fiveFU, selection_name = "5-FU_only")

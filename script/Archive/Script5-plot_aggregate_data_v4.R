...
plot_single("aggregatedv4", select_on = "Passed_QC", aggregate_on = "response_5FU_chemo_naive", condition='5-FU', WGS=TRUE)
plot_single("aggregatedv4", select_on = "Passed_QC", aggregate_on = "response_oxaliplatin_chemo_naive", condition='Oxaliplatin', WGS=TRUE)

...
WGS_output <- file.path(home_dir, "7_WGS")
...
categorized_columns$SBS17_threshold <- ifelse(categorized_columns$SBS17>1000, "present", "absent")

file_path <- file.path(WGS_output, "categorized_columns.csv")
write.csv(categorized_columns, file_path, row.names = FALSE)
...
plot_multiple("PassedQC9_nonfit", select_on="Passed_QC", fitcurves = FALSE)

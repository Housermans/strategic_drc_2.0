...
# Load your data
d <- select_files_and_add_metadata(select_on="Passed_QC", plot_condition="all", individual_reps=TRUE)

# Extract unique concentrations for 5-FU and Oxaliplatin
concentrations_5fu <- extract_concentrations(d, "5-FU")
concentrations_oxaliplatin <- extract_concentrations(d, "Oxaliplatin")
...
print(concentrations_5fu)
print(concentrations_oxaliplatin)

...
# Change sample names
PDO_metadata_screen$sampleId <- gsub("Met", "", PDO_metadata_screen$sampleId)
sig_PDO_categorized$sampleId <- gsub("Met", "", sig_PDO_categorized$sampleId)
PDO_WGS_screen$sampleId <- gsub("Met", "",PDO_WGS_screen$sampleId)
PDO_RNA_screen$sampleId <- gsub("Met", "", PDO_RNA_screen$sampleId)
mat_HMF_treatment$sampleId <- gsub("Met", "", mat_HMF_treatment$sampleId)

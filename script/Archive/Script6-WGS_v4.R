...
library(data.table)
dt <- data.table(
  Var1 = rep(c(rep("OPTC01030042T", 6), rep("OPTC01030050T", 6), rep("OPTC01030055T", 6),
               rep("OPTC01040025T", 6), rep("OPTC01040026T", 6), rep("OPTC01040028T", 6))),
  Var2 = rep(c(rep("BRCA2 (5%)", 2), rep("TP53 (10%)", 2), rep("EGFR (15%)", 2)), times = 9),
  V1 = c(rep(c("Mutation1", "Mutation2"), each = 3), 
         rep(c("Mutation2", "NA"), each = 3), 
         rep(c("Mutation1", "Mutation3"), each = 3)),
  shift = rep(0, 36),
  height = rep(1, 36),
  test = rep(1, 36),
  test2 = rep(1, 36),
